function [r,y_test_all,yhat,coef] = run_ability_predict_permutation(n,sublist,all_sub_func_rest1,random_node);
    language_ability = sublist(:,n);%
    covariates = sublist(:,[17,18,19]);%age,sex,motion
    ...
    for j=1:2
        ...
        % permutation should be on trainning set
        rand_loction_2 = randperm(size(x,1));
        x = x(rand_loction_2,:);
