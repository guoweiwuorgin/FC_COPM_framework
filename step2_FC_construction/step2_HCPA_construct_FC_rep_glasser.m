...
%%
template_dir = '/root_dir/wuguowei/code/FC_ontology/';
glasser_360 = cifti_read([template_dir 'glasser_360.dlabel.nii']);% 200 and 400, 200 for replication
...
out_dir = '/root_dir/wuguowei/code/FC_ontology/FC_net_SP_glasser';
if ~exist(out_dir,'dir')
	mkdir(out_dir);
end
n_iter_2 = 1;
n_iter_1 = 1;
net_parcel = glasser_360.cdata;
for sub = 1:numel(subject_name)
    ...
    if numel(rest1)==2 && ~exist([out_dir filesep subname filesep  'schaefer_400_run1.mat'],'file') && numel(rest2)==2 && ~exist([out_dir filesep subname filesep  'schaefer_400_run2.mat'],'file')
       ...
       rest1_conn = convet_matrix_to_vector(atanh(corr(rest1(1:end,:)')));
       out_rest1 = [out_dir filesep subname filesep  'glasser_360_run1.mat'];
       ...
       rest2_conn = convet_matrix_to_vector(atanh(corr(rest2(1:end,:)')));
       if ~exist([out_dir filesep subname],'dir')
            mkdir([out_dir filesep subname]);
       end
        all_rest = [rest1 rest2];
        rest_conn = convet_matrix_to_vector(atanh(corr(all_rest(1:end,:)')));
       out_rest2 = [out_dir filesep subname filesep  'glasser_360_run2.mat'];
       save(out_rest2,'rest2_conn');
       out_rest= [out_dir filesep subname filesep  'glasser_360.mat'];
